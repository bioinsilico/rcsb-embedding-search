...
from dataset.tm_score_fold_cross_validation_from_embeddings_dataset import \
    TmScoreFoldCrossValidationFromEmbeddingsDataset
...
def main(cfg: TrainingConfig):
    ...
    training_set = TmScoreFoldCrossValidationFromEmbeddingsDataset(
        tm_score_file=cfg.training_set.tm_score_file,
        training_class_file=cfg.training_set.training_class_file,
        testing_class_file=cfg.training_set.testing_class_file,
        number_of_folds=cfg.training_set.number_of_folds,
        fold_number=cfg.training_set.fold_number,
