...
from lightning_module.training.lightning_pst_graph_static_validation import LitStructurePstGraphStaticValidation
...
def main(cfg: TrainingConfig):
    ...
    model = LitStructurePstGraphStaticValidation(
        nn_model=nn_model,
